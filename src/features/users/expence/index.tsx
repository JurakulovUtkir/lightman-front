...
import { Route } from '@/routes/_authenticated/users/expence/$id'
...
const UserExpence = () => {
  ...
  const { lang, tUser, general, interpolate } = useLang()
  const t = tUser[lang]
  ...
  const {
    ...
    from: '/_authenticated/users/expence/$id',
  })
        ...
        <div className='mb-2 flex flex-wrap items-center justify-between space-y-2 gap-x-4'>
          <div>
            ...
            <p className='text-muted-foreground'>
              {interpolate(t.list_user_expence, {
