...
import { useDeposits } from '@/features/deposits/data/hooks'
...
interface FormComboboxProps<T extends FieldValues> {
  ...
  label: string
  control: Control<T>
  detail?: Pick<DepositSchema, 'id' | 'name' | 'balance'>
}

export const FormComboboxDeposit = <T extends FieldValues>({
  name,
  label,
  control,
  detail,
  ...
  const isLoading = isLoadingDeposits || isFetchingDeposits
    ...
    <FormField
      ...
      render={({ field }) => {
        ...
        let options: ComboboxOption[] =
          depositsResponse?.data?.data?.map((deposit) => ({
            value: deposit.id,
            label: deposit.name,
