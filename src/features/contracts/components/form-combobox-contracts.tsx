...
import { useContracts } from '@/features/contracts/data/hooks'
...
interface FormComboboxProps<T extends FieldValues> {
  ...
  // Add any contract-specific filters here if needed
  // filterActive?: boolean
}

export const FormComboboxContract = <T extends FieldValues>({
  name,
  label,
  control,
  detail,
  ...
  const isLoading = isLoadingContracts || isFetchingContracts
                ...
                <Command shouldFilter={false}>
                  ...
                  <CommandList>
                    {isLoading ? (
                      ...
                      <>
                        <CommandEmpty>{t.no_contracts}</CommandEmpty>
                        <CommandGroup>
                          {options.map((item) => (
                            <CommandItem
                              value={item.label}
